...
{
	public static class MySqlApplicationInstanceIdSourceExtensions
	{
		/// <summary>
		/// <para>
			...
			string? databaseName = null)
		{
			...
			IApplicationInstanceIdSource CreateInstance(IServiceProvider serviceProvider)
			{
				...
				var instance = ApplicationInstanceIdSourceFactory.Create(applicationLifetime, () => new MySqlApplicationInstanceIdSource(
