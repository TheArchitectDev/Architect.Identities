...
{
	public static class SqlServerApplicationInstanceIdSourceExtensions
	{
		/// <summary>
		/// <para>
			...
			string? databaseAndSchemaName = null)
		{
			...
			IApplicationInstanceIdSource CreateInstance(IServiceProvider serviceProvider)
			{
				...
				var instance = ApplicationInstanceIdSourceFactory.Create(applicationLifetime, () => new SqlServerApplicationInstanceIdSource(
					GetConnectionFromFactory,
					databaseAndSchemaName,
					applicationLifetime,
					exceptionHandler));
				return instance;
