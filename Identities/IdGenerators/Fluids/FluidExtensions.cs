...
namespace Architect.Identities
{
	public static class FluidExtensions
	{
		...
		/// </para>
		/// <para>
		/// Deviation from the default distribution is an advanced feature that should be used with great care.
		/// </para>
		/// <para>
		...
		/// </para>
		/// <para>
		/// Once any IDs have been stored, the distribution should not be modified, as doing so could result in an existing ID being generated again.
		/// </para>
		/// </summary>
