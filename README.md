...
The generator is registered on startup. It needs a small, unique ID for the application, in order to generate IDs that are strictly different from those generated by other applications or servers.
